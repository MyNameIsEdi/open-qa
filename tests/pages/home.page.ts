...
export class HomePage extends BasePage {
  ...
  constructor(page: Page) {
    ...
    this.selfHealingTestCardIcon = this.selfHealingTestsCard.getByTestId('home.feature_healing_title_icon');
    ...
    this.smartDataGenCardIcon = this.smartDataGenCard.getByTestId('home.feature_datagen_title_icon');
    ...
    this.autoBugTriageCardIcon = this.autoBugTriageCard.getByTestId('home.feature_triage_title_icon');
    ...
    this.claudePoweredCardIcon = this.claudePoweredCard.getByTestId('home.feature_claude_title_icon');
    ...
    this.dailyMissionsCardIcon = this.dailyMissionsCard.getByTestId('home.feature_missions_title_icon');
