    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
      ...
      <div style={{ borderRadius: 9, overflow: 'hidden', border: '1px solid #e2e8f0' }}>
        ...
        <div
          style={{
            display: 'grid',
            gridTemplateColumns: '36px 1fr 80px 70px',
            background: '#f8fafc',
      ...
      >
        ✓ 3 rows match <code style={{ fontFamily: 'monospace' }}>status = 'failed'</code> — QA use
        case: find all failed orders
      </div>
    </div>
  );
}
