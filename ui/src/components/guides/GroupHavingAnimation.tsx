...
const GROUPS = [
  ...
  { user: 'carol@test.com', count: 9, bar: '90%', fails: true,  delay: 0.90 },
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
      ...
      <div style={{ display: 'flex', gap: 7 }}>
        {[
          { label: 'WHERE', desc: 'Filters individual rows (before grouping)',  color: '#f97316', delay: 0.2 },
          { label: 'HAVING', desc: 'Filters groups (after GROUP BY)',           color: '#3b82f6', delay: 0.35 },
        ].map(t => (
          <div key={t.label} style={{
            animation: `qa-groupIn .35s ease ${t.delay}s both`,
            flex: 1, padding: '7px 10px', borderRadius: 9,
            background: t.color + '12', border: `1.5px solid ${t.color}44`,
          }}>
      ...
      <div style={{
        ...
        background: '#fff7ed', border: '1px solid #fed7aa', fontSize: 10.5, color: '#9a3412',
      }}>
