    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
      ...
      <div style={{ display: 'flex', gap: 10, alignItems: 'center' }}>
        ...
        >
          ...
          <p style={{ fontSize: 9.5, fontWeight: 700, color: '#475569', margin: '4px 0 0' }}>
            Database
          </p>
      ...
      <div
        style={{
          animation: 'qa-rowPop .4s ease .9s both',
          borderRadius: 9,
          overflow: 'hidden',
      ...
      >
        ...
        {ROWS.map((r, i) => (
          ...
          >
            ...
            <div style={{ padding: '5px 10px', fontSize: 10, color: '#1f2937', fontWeight: 500 }}>
              {r.name}
            </div>
            <div
              style={{
      ...
      <div style={{ display: 'flex', gap: 6 }}>
        {CRUD.map((c) => (
          ...
          >
            <p style={{ fontSize: 9.5, fontWeight: 800, color: c.color, margin: '0 0 2px' }}>
              {c.op}
            </p>
