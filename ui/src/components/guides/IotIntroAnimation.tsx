...
const CHALLENGES = [
  ...
  { icon: '🧪', text: 'Simulate sensors (MQTT, HIL rigs)', delay: 1.7 },
...
export function IotIntroAnimation() {
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
        {DEVICES.map((d) => (
          ...
          >
            ...
            <div style={{ flex: 1 }}>
              <p style={{ fontSize: 12, fontWeight: 700, color: d.color, margin: '0 0 5px' }}>
                {d.name}
              </p>
      ...
      >
        ⏰ <strong>Watchdog timer</strong> — if firmware hangs, the device resets itself. QA must
        test this failsafe.
      </div>
    </div>
  );
