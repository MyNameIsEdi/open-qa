  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
      ...
      <div style={{ position: 'relative', display: 'flex', alignItems: 'center', gap: 0 }}>
        ...
        {/* FK arrow */}
        <div
          style={{ animation: 'qa-tblIn .4s ease .6s both', padding: '0 6px', textAlign: 'center' }}
        >
          ...
          {[
            ...
            >
              <span
                style={{
                  fontSize: 10,
                  fontWeight: r.bold || r.fk ? 700 : 400,
                  color: r.fk ? '#854d0e' : r.bold ? '#15803d' : '#374151',
                }}
              >
                {r.col}
              </span>
      ...
      >
        🔗 <strong>user_id</strong> in orders points to <strong>id</strong> in users — one user can
        have many orders (1:N)
      </div>
        ...
        {[
          {
            ...
            icon: '📋',
            desc: 'Tables, rows, strict schema',
            color: '#3b82f6',
            delay: 1.1,
          },
          {
            label: 'NoSQL',
            icon: '📄',
            desc: 'Documents, flexible schema',
            color: '#a855f7',
            delay: 1.3,
          },
        ].map((t) => (
