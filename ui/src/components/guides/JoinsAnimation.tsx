...
const JOIN_TYPES = [
  {
    ...
    leftFill: 'rgba(59,130,246,.15)',
    rightFill: 'rgba(34,197,94,.15)',
    midFill: '#6366f1',
    color: '#6366f1',
    delay: 0.1,
    rows: [
              ...
              >
                ...
                <div
                  style={{
                    ...
                    color: r.right === 'NULL' ? '#ef4444' : '#374151',
                    fontWeight: r.right === 'NULL' ? 700 : 400,
                  }}
                >
                  {r.right}
                </div>
                <div
                  style={{
                    padding: '5px 9px',
                    fontSize: 9.5,
                    color: r.right === 'NULL' ? '#f97316' : '#16a34a',
                  }}
                >
                  {r.note}
                </div>
