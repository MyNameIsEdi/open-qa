...
const OWASP = [
  {
    ...
    color: '#ef4444',
    delay: 0.1,
    qa: 'Test input fields with special chars',
  },
  {
    rank: 'A02',
    ...
    color: '#f97316',
    delay: 0.35,
    qa: 'Try login with expired token',
  },
  {
    rank: 'A03',
    name: 'XSS',
    ...
    color: '#eab308',
    delay: 0.6,
    qa: 'Submit <script>alert(1)</script>',
  },
  {
    rank: 'A05',
    ...
    color: '#a855f7',
    delay: 0.85,
    qa: 'Check debug/stack trace in errors',
  },
  {
    rank: 'A07',
      ...
      <div style={{ borderRadius: 10, border: '1.5px solid #bbf7d0', overflow: 'hidden' }}>
        <div style={{ background: '#16a34a', padding: '5px 11px' }}>
          <p style={{ fontSize: 10, fontWeight: 700, color: '#fff', margin: 0 }}>
            ✓ Basic security checks every QA should run
          </p>
        </div>
        {CHECKS.map((c, i) => (
          <div
            ...
            style={{
              ...
              padding: '7px 11px',
              borderTop: i > 0 ? '1px solid #f0fdf4' : 'none',
              display: 'flex',
              gap: 7,
              alignItems: 'center',
              background: 'white',
