...
export function ApiPostmanAnimation() {
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
      ...
      <div style={{
        border: '1.5px solid #e2e8f0', borderRadius: 13, overflow: 'hidden',
        animation: 'qa-pmIn .4s ease 0s both',
      }}>
        {/* Postman-style top bar */}
        <div style={{
          background: '#ef6c00', padding: '7px 14px',
        ...
        <div style={{ display: 'flex', minHeight: 160 }}>
          ...
          <div style={{
            ...
            background: '#fafafa', padding: '10px 0',
          }}>
            <p style={{ fontSize: 9, fontWeight: 700, color: '#94a3b8', padding: '0 12px 6px',
            ...
            {COLLECTION.map((c, i) => (
              <div key={i} style={{
                ...
                <span style={{ fontSize: 10, color: c.method ? '#374151' : '#1f2937',
          ...
          <div style={{ flex: 1, padding: '10px 14px', display: 'flex', flexDirection: 'column', gap: 8 }}>
            ...
            <div style={{
              ...
              <span style={{
                fontSize: 9.5, fontWeight: 800, color: '#22c55e',
                background: '#f0fdf4', border: '1px solid #bbf7d0',
                padding: '3px 7px', borderRadius: 5,
              }}>POST</span>
              <code style={{
                flex: 1, fontSize: 10, background: '#f8fafc',
                border: '1px solid #e2e8f0', borderRadius: 6,
                padding: '4px 8px', color: '#374151',
              }}>{'{{baseUrl}}/api/login'}</code>
              <button style={{
                fontSize: 9.5, fontWeight: 700, background: '#3b82f6',
            ...
            <div style={{
              ...
              background: '#1e293b', borderRadius: 7, padding: '7px 10px',
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 4 }}>
              {TEST_RESULTS.map((r, i) => (
                <div key={i} style={{
                  ...
                  fontSize: 10, fontWeight: r.pass ? 500 : 600,
