...
export const MODULES: GuideModule[] = [
  {
    ...
    sections: [
      ...
      },
      {
        ...
        level: 'Beginner',
        minutes: 3,
        summary: 'A roadmap of the full course: 8 modules covering automation, API, load, IoT, SQL, AI, DevOps and security testing.',
        summaryHe: 'מפת דרכים של הקורס המלא: 8 מודולים המכסים אוטומציה, API, עומסים, IoT, SQL, AI, DevOps ובדיקות אבטחה.',
    ...
    sections: [
      {
        ...
        level: 'Beginner',
        minutes: 12,
        summary: 'Learn the ROI logic behind test automation decisions using a practical decision matrix.',
...
- Setup cost > 10× the time saved`,
      ...
      },
      {
        ...
        level: 'Beginner',
        minutes: 10,
        summary: 'Install Playwright, understand the project structure, and run your first test from the command line.',
        summaryHe: 'התקן את Playwright, הבן את מבנה הפרויקט, והרץ את הבדיקה הראשונה שלך משורת הפקודה.',
  ...
  projects: [
    ...
    { name: 'firefox',  use: { ...devices['Desktop Firefox'] } },
      ...
      },
      {
        ...
        level: 'Beginner',
        minutes: 10,
        summary: 'Understand the anatomy of a Playwright test and write a complete working test from scratch.',
...
test('user can search for products', async ({ page }) => {
  ...
  await expect(page.locator('.results-count')).toContainText('results')
      ...
      },
      {
        ...
        level: 'Intermediate',
        minutes: 15,
        summary: 'Learn the 5 locator types in Playwright and choose the most resilient one for each element.',
...
test('locator examples', async ({ page }) => {
  ...
  await modal.getByRole('button', { name: 'Confirm' }).click()
      ...
      },
      {
        ...
        level: 'Intermediate',
        minutes: 15,
        summary: 'Eliminate duplicated locators by wrapping each page in a class — the standard for maintainable test suites.',
        summaryHe: 'בטל locators כפולים על ידי עטיפת כל דף במחלקה — הסטנדרט לחבילות בדיקות שניתנות לתחזוקה.',
    ...
    sections: [
      {
        ...
        level: 'Intermediate',
        minutes: 15,
        summary: 'Use Playwright\'s request fixture to test REST APIs without a browser — 10× faster than UI tests.',
        summaryHe: 'השתמש ב-request fixture של Playwright לבדיקת REST APIs ללא דפדפן — מהיר פי 10 מבדיקות UI.',
...
test('401 without token', async ({ request }) => {
  ...
  expect(res.status()).toBe(401)
      ...
      },
      {
        ...
        level: 'Beginner',
        minutes: 10,
        summary: 'Explore APIs with Postman\'s GUI, write test scripts, and run them in CI with Newman.',
    ...
    sections: [
      {
        ...
        level: 'Intermediate',
        minutes: 12,
        summary: 'Learn how QA engineers test software that runs on hardware — from ATMs to smart fridges.',
      ...
      },
      {
        ...
        minutes: 15,
        practiceDesc: 'Design test cases for a smart door lock system — an IoT device controlled by a mobile app.',
        practiceDescHe: 'עצב תרחישי בדיקה למערכת מנעול דלת חכמה — מכשיר IoT הנשלט על ידי אפליקציית מובייל.',
        practiceItems: [
    ...
    sections: [
      {
        ...
        level: 'Beginner',
        minutes: 10,
        summary: 'Learn what SQL is, why every QA engineer needs it, and how to write your first query.',
...
DELETE FROM users WHERE email LIKE '%@test.com';`,
      ...
      },
      {
        ...
        level: 'Beginner',
        minutes: 15,
        summary: 'Understand relational vs NoSQL databases, ERD basics, and why indexes matter for QA.',
...
CREATE INDEX idx_orders_status  ON orders(status);`,
      ...
      },
      {
        ...
        level: 'Beginner',
        minutes: 15,
        summary: 'Master the most-used SQL shape: filter rows with WHERE and common comparison operators.',
...
LIMIT 20;`,
      ...
      },
      {
        ...
        level: 'Intermediate',
        minutes: 12,
        summary: 'Aggregate rows into groups and filter groups with HAVING — essential for QA data analysis.',
...
ORDER BY failed_attempts DESC;`,
      ...
      },
      {
        ...
        level: 'Intermediate',
        minutes: 15,
        summary: 'Combine data from multiple tables with JOINs and find or exclude rows with EXISTS.',
...
ORDER BY created_at DESC;`,
      ...
      },
      {
        ...
        level: 'Intermediate',
        minutes: 15,
        summary: 'A collection of battle-tested SQL patterns every QA engineer uses in their daily work.',
    ...
    sections: [
      {
        ...
        level: 'Advanced',
        minutes: 10,
        summary: 'Use AI as a force multiplier for QA work — generating test cases, writing SQL, and explaining code.',
  ...
  test:
    ...
    steps:
      ...
      },
      {
        ...
        level: 'Intermediate',
        minutes: 10,
        summary: 'Learn OWASP Top 10 vulnerabilities and the basic security checks every QA engineer should perform.',
        summaryHe: 'למד את 10 הפגיעויות המובילות של OWASP ובדיקות האבטחה הבסיסיות שכל מהנדס QA צריך לבצע.',
    ...
    sections: [
      {
        ...
        minutes: 10,
        summary: 'Prepare for QA job interviews with real questions, model answers, and portfolio advice.',
