        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="flex flex-col flex-1">
            ...
            <textarea
              ...
              rows={10}
              placeholder={
                PLACEHOLDER_MAP[selectedPrompt.name] ??
                'Paste your PRD, log, spec, or test code here…'
              }
        ...
        <div className="flex flex-col gap-2">
          ...
          >
            {error ? (
              ...
              <pre
                className="p-4 text-sm leading-relaxed whitespace-pre-wrap overflow-auto h-full"
                style={{ color: 'var(--text-main)' }}
              >
                {output}
              </pre>
              ...
              >
                ...
                <p className="text-sm text-center">{t('playground.empty_hint')}</p>
              </div>
            )}
          </div>
        </div>
