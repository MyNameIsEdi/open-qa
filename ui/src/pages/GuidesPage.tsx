...
const SECTION_DOWNLOADS: Record<string, DownloadCard[]> = {
  'intro-qa': [
    {
      name: 'QA Fundamentals Checklist',
      nameHe: 'רשימת תיוג יסודות QA',
      desc: 'All core concepts — pyramid, bug lifecycle, test types',
      descHe: 'כל מושגי הבסיס — פירמידה, מחזור חיי באג, סוגי בדיקות',
      type: 'PDF',
      size: '1.2 MB',
    },
    {
      name: 'Testing Pyramid Cheat Sheet',
      nameHe: 'דף רמאות — פירמידת הבדיקות',
      desc: 'One-page Unit / Integration / E2E comparison table',
      descHe: 'טבלת השוואה חד-עמודית Unit / Integration / E2E',
      type: 'MD',
      size: '0.3 MB',
    },
  ],
  'when-to-automate': [
    {
      ...
      nameHe: 'מחשבון ROI לאוטומציה',
      desc: 'Excel file — enter run frequency, get ROI decision',
      descHe: 'קובץ Excel — הכנס תדירות ריצה, קבל החלטת ROI',
      type: 'XLSX',
      size: '0.8 MB',
    },
    {
      name: 'Decision Matrix Template',
      nameHe: 'תבנית מטריצת החלטות',
      desc: 'Ready-to-fill template for planning sessions',
      descHe: 'תבנית מוכנה למילוי לפגישות תכנון',
      type: 'PDF',
      size: '0.5 MB',
    },
  ],
  'setup-playwright': [
    {
      name: 'Playwright Setup Guide',
      nameHe: 'מדריך הגדרת Playwright',
      desc: 'Windows, Mac & Linux setup with troubleshooting tips',
      descHe: 'מדריך התקנה ל-Windows, Mac ו-Linux עם פתרון בעיות',
      type: 'PDF',
      size: '2.1 MB',
    },
    {
      name: 'Playwright Commands Cheat Sheet',
      nameHe: 'דף רמאות — פקודות Playwright',
      desc: 'Most-used commands on a single A4 sheet',
      descHe: 'הפקודות הכי שימושיות בגיליון A4 אחד',
      type: 'PDF',
      size: '0.9 MB',
    },
  ],
  locators: [
    {
      ...
      nameHe: 'מדריך אסטרטגיית Locators',
      desc: 'Priority order and when to use each locator type',
      descHe: 'סדר עדיפויות ומתי להשתמש בכל סוג locator',
      type: 'PDF',
      size: '0.7 MB',
    },
  ],
  pom: [
    {
      name: 'POM Starter Template',
      nameHe: 'תבנית התחלה לPOM',
      desc: 'Ready-to-use TypeScript POM with LoginPage example',
      descHe: 'תבנית TypeScript מוכנה לשימוש עם דוגמת LoginPage',
      type: 'MD',
      size: '0.2 MB',
    },
  ],
  'api-playwright': [
    {
      name: 'REST API Test Recipes',
      nameHe: 'מתכוני בדיקת REST API',
      desc: 'GET, POST, auth, error handling patterns',
      descHe: 'דפוסי GET, POST, auth וטיפול בשגיאות',
      type: 'PDF',
      size: '0.6 MB',
    },
  ],
  'api-postman': [
    {
      name: 'Postman Collection Template',
      nameHe: 'תבנית Collection לPostman',
      desc: 'Importable collection with env variables wired up',
      descHe: 'קולקשן מוכן לייבוא עם משתני סביבה מוגדרים',
      type: 'MD',
      size: '0.4 MB',
    },
  ],
  'load-types': [
    {
      name: 'k6 Starter Script',
      nameHe: 'סקריפט k6 להתחלה',
      desc: 'Ready-to-run k6 script with 50 VUs, 1 min ramp-up',
      descHe: 'סקריפט k6 מוכן להרצה עם 50 VUs ורמפ-אפ של דקה',
      type: 'MD',
      size: '0.2 MB',
    },
    {
      name: 'Load Test Results Template',
      nameHe: 'תבנית תוצאות בדיקת עומס',
      desc: 'P50/P95/P99 reporting template for stakeholders',
      descHe: 'תבנית דיווח P50/P95/P99 לבעלי עניין',
      type: 'XLSX',
      size: '0.5 MB',
    },
  ],
  'sql-qa-queries': [
    {
      name: 'QA SQL Query Library',
      nameHe: 'ספריית שאילתות SQL ל-QA',
      desc: '20 battle-tested queries for data validation',
      descHe: '20 שאילתות נבדקות בשדה לאימות נתונים',
      type: 'MD',
      size: '0.3 MB',
    },
  ],
  'security-testing': [
    {
      ...
      nameHe: 'רשימת תיוג בדיקות אבטחה',
      desc: 'OWASP Top 10 checks every QA should run',
      descHe: 'בדיקות OWASP Top 10 שכל QA צריך להריץ',
      type: 'PDF',
      size: '0.8 MB',
    },
  ],
  'interview-tips': [
    {
      name: 'QA Interview Prep Sheet',
      nameHe: 'גיליון הכנה לראיון QA',
      desc: 'Top 15 questions with model answers',
      descHe: '15 השאלות הנפוצות עם תשובות מודל',
      type: 'PDF',
      size: '1.1 MB',
    },
  ],
          ...
          return (
            ...
            >
              ...
              <div className="flex items-center justify-between mt-auto">
                ...
                <button
                  className="flex items-center gap-1 px-3 py-1.5 rounded-lg text-[11px] font-bold text-white transition-all hover:-translate-y-0.5"
...
const SECTION_CALLOUTS: Record<string, Callout[]> = {
  'intro-qa': [
    {
      type: 'tip',
      title: 'Tip before you start',
      titleHe: 'טיפ לפני שמתחילים',
      body: 'Read → try it yourself → take the quiz → repeat. No need to memorize everything — understanding the concept is enough.',
      bodyHe:
        'קרא → נסה בעצמך → עשה את החידון → חזור. לא חייבים לזכור הכל — מספיק להבין את הרעיון.',
    },
  ],
  'when-to-automate': [
    {
      type: 'warning',
      title: 'Brittle Tests — Beware',
      titleHe: 'בדיקות שבירות — הזהר',
      ...
      bodyHe:
        'בדיקה שנשברת בכל שינוי UI קטן עולה יותר ממה שהיא שווה. אם הבדיקה שלך נכשלת כי שינית צבע כפתור — היא לא בדיקה טובה. נלמד איך להימנע מזה עם locators חזקים במודול 2.',
    },
  ],
  'setup-playwright': [
    {
      ...
      titleHe: 'למה Playwright ולא Selenium?',
      ...
      bodyHe:
        'ל-Playwright יש auto-wait מובנה — הוא ממתין לאלמנטים לפני שהוא מקיים איתם אינטראקציה. פחות flaky tests, ללא קריאות sleep(), אמינות גבוהה יותר.',
    },
  ],
  'first-test': [
    {
      ...
      bodyHe:
        'Playwright מצלם screenshot ו-trace אוטומטית כשבדיקה נכשלת. הרץ npx playwright show-report כדי לראות את הדוח הויזואלי המלא.',
    },
  ],
  locators: [
    {
      ...
      bodyHe:
        'השתמש: getByRole → getByLabel → getByTestId → CSS → XPath (אחרון). locators מבוססי role שורדים עיצובים מחדש כי הם בודקים כוונה, לא מימוש.',
    },
  ],
  pom: [
    {
      type: 'tip',
      title: 'POM = TV Remote Analogy',
      titleHe: 'POM = אנלוגיה לשלט טלוויזיה',
      ...
      bodyHe:
        'חשוב על Page Object כמו שלט טלוויזיה — מקום אחד לכל פקדי הכפתורים. כשה-UI של הטלוויזיה משתנה, אתה מעדכן את השלט, לא כל אדם שמשתמש בו.',
    },
  ],
  'api-playwright': [
    {
      type: 'info',
      title: 'API tests are 10× faster',
      titleHe: 'בדיקות API מהירות פי 10',
      ...
      bodyHe:
        'בדיקות API מדלגות על הדפדפן לחלוטין — אין rendering, אין המתנה ל-DOM. חבילת בדיקות API שלוקחת 30 שניות תיקח 5 דקות כבדיקות UI.',
    },
  ],
  'load-types': [
    {
      type: 'info',
      title: 'Road types analogy',
      titleHe: 'אנלוגיית סוגי הכבישים',
      body: 'Load = normal traffic | Performance = rush hour | Stress = accident blocking lanes | Soak = marathon runner — slow leak over hours.',
      bodyHe:
        'עומס = תנועה רגילה | ביצועים = שעת עומס | לחץ = תאונה שחוסמת נתיבים | Soak = רץ מרתון — דליפה איטית לאורך שעות.',
    },
  ],
  'sql-intro': [
    {
      type: 'tip',
      title: 'Why QA engineers need SQL',
      titleHe: 'למה מהנדסי QA צריכים SQL',
      ...
      bodyHe:
        'באגים בצד השרת לעתים קרובות מתחבאים בנתונים. SQL מאפשר לך לאמת את ה-DB ישירות — למצוא רשומות רפאים, לאמת migrations, לתפוס כפילויות שה-UI לא מראה.',
    },
  ],
  'security-testing': [
    {
      ...
      bodyHe:
        'מהנדסת QA מצאה באג שיכול היה לחשוף 50,000 רשומות משתמשים — רק על ידי בדיקת מה קורה כשמשנים פרמטר URL. זה IDOR.',
    },
  ],
  'interview-tips': [
    {
      ...
      titleHe: 'מה שמראיינים באמת מחפשים',
      ...
      bodyHe:
        'סקרנות, תשומת לב לפרטים ותקשורת ברורה. מועמד שאומר "מצאתי באג שמנע checkout ל-20% מהמשתמשים" מנצח את מי ששינן 100 הגדרות בדיקה.',
    },
  ],
};
...
function CalloutBox({ callout, isHe }: { callout: Callout; isHe: boolean }) {
  ...
  return (
    <div
      className="flex gap-3 px-4 py-3.5 rounded-xl text-xs leading-relaxed"
    ...
    >
      ...
      <div>
        ...
        <p style={{ color: 'var(--text-muted)' }}>{isHe ? callout.bodyHe : callout.body}</p>
      </div>
    </div>
  );
}
...
const ANIMATION_LABELS: Record<string, [string, string]> = {
  'intro-qa': [
    'Testing Pyramid — live animation',
    'פירמידת הבדיקות — אנימציה חיה מוצגת כאן בדיוק כשהמושג מוזכר לראשונה',
  ],
  'course-overview': [
    'Course roadmap — all 8 modules at a glance',
    'מפת הקורס — כל 8 המודולים במבט אחד',
  ],
  'when-to-automate': [
    'Decision tree — automate or not?',
    'עץ ההחלטות — לאוטמט או לא? מוצג לאחר שאלת מתי לאוטמט',
  ],
  'setup-playwright': [
    'Terminal walkthrough — npm init playwright@latest',
    'הדגמת טרמינל — ההתקנה מוצגת אחרי תיאור שלב-אחר-שלב',
  ],
  'first-test': [
    'Anatomy of a test — live code trace',
    'אנטומיית בדיקה — ממחישה את מבנה הבדיקה שתואר בטקסט',
  ],
  locators: [
    'Locator strategies — interactive demo',
    'אסטרטגיות Locator — מוצגות אחרי הסבר חמשת הסוגים',
  ],
  pom: [
    'Page Object Model — before vs after',
    'Page Object Model — השוואת לפני/אחרי מיד לאחר האנלוגיה',
  ],
  'api-playwright': [
    'API request flow — Playwright fixture',
    'זרימת בקשת API — מוצגת עם הסבר request fixture',
  ],
  'api-postman': [
    'Postman collection — GUI walkthrough',
    'הדגמת Postman — ממחישה את ה-Collections שתוארו',
  ],
  'load-types': [
    'Load test metrics — P95 / P99 in real time',
    'מדדי בדיקת עומס — P95/P99 בזמן אמת',
  ],
  'iot-intro': [
    'Embedded system signals — sensor simulation',
    'אותות מערכת משובצת — סימולציית חיישן',
  ],
  'sql-intro': [
    'SQL filing cabinet — data retrieval analogy',
    'ארון תיוק SQL — ממחיש את אנלוגיית אחזור נתונים',
  ],
  ...
  'ai-testing': [
    'Claude prompt — generating a Playwright test',
    'פרומפט ל-Claude — יצירת בדיקת Playwright',
  ],
  'devops-qa': ['CI/CD pipeline — tests running on PR', 'צינור CI/CD — בדיקות רצות על PR'],
  'security-testing': [
    'OWASP attack surface — request interception',
    'משטח התקפה OWASP — יירוט בקשות',
  ],
  ...
  return (
    ...
    >
      ...
      >
        ...
        <span className="flex-1 min-w-0 truncate">{label ? (isHe ? label[1] : label[0]) : ''}</span>
        <span
...
const AUTOMATE_YES = {
  en: [
    ...
    'Multi-browser tests (Chrome, Firefox, WebKit)',
    'Smoke tests on every PR',
    'Tests with large data sets',
    'Login / auth flows that run constantly',
  ],
  he: [
    'בדיקות רגרסיה שרצות בכל build',
    'בדיקות multi-browser (Chrome, Firefox, WebKit)',
    'smoke tests על כל PR',
    'בדיקות עם מערכי נתונים גדולים',
    'זרימות login / auth שרצות תמיד',
  ],
};
const AUTOMATE_NO = {
  en: [
    'Exploratory testing — finding unexpected issues',
    'UX / subjective user experience checks',
    'One-time test before a single release',
    'Feature whose UI changes every week',
    'When cost of automation > benefit',
  ],
  he: [
    'Exploratory testing — גילוי בעיות לא צפויות',
    'בדיקות UX / חווית משתמש סובייקטיבית',
    'בדיקה one-time לפני release חד-פעמי',
    'פיצ׳ר שה-UI שלו משתנה כל שבוע',
    'כשעלות האוטומציה גבוהה מהתועלת',
  ],
};
...
function DecisionMatrix({ isHe }: { isHe: boolean }) {
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 rounded-xl overflow-hidden">
      ...
      >
        <p className="text-xs font-bold mb-3" style={{ color: '#b91c1c' }}>
          ❌ {isHe ? 'לא — ידני' : "Don't Automate"}
        </p>
        <ul className="flex flex-col gap-1.5">
...
function typeIcon(type: GuideSection['type']) {
  switch (type) {
    case 'quiz':
      return <QuizOutlinedIcon sx={{ fontSize: 14 }} />;
    case 'practice':
      return <BuildOutlinedIcon sx={{ fontSize: 14 }} />;
    case 'exam':
      return <ScienceOutlinedIcon sx={{ fontSize: 14 }} />;
    case 'tips':
      return <LightbulbOutlinedIcon sx={{ fontSize: 14 }} />;
    case 'summary':
      return <MenuBookOutlinedIcon sx={{ fontSize: 14 }} />;
    default:
      return <ArticleOutlinedIcon sx={{ fontSize: 14 }} />;
  }
}
    ...
    >
      {completed ? (
        ...
        <>
          ...
          {isHe ? 'סמן כהושלם' : 'Mark as complete'}
        </>
      )}
    </button>
  );
...
function QuizContent({
  ...
  return (
    <div className="flex flex-col gap-6">
              ...
              {opts.map((opt, i) => {
                ...
                if (isAnswered) {
                  if (isSelected && isCorrect)
                    cls = 'border-2 border-sage-400 bg-sage-50 cursor-default';
      ...
      {allAnswered && <CompleteButton completed={false} onToggle={onComplete} isHe={isHe} />}
    </div>
  );
}
...
function LessonContent({
  ...
  return (
    <div className="flex flex-col gap-5">
      ...
      {section.level && (
        <span
          className={`self-start text-xs font-medium px-2.5 py-1 rounded-full ${levelColors[section.level]}`}
        >
          {isHe
      ...
      {/* Callout boxes */}
      {callouts.map((c, i) => (
        <CalloutBox key={i} callout={c} isHe={isHe} />
      ))}
      ...
      {Animation && <AnimationFigure sectionId={section.id} isHe={isHe} Animation={Animation} />}
...
function SectionContent({
  ...
  if (section.type === 'practice') {
    return (
      <PracticeContent section={section} completed={completed} onToggle={onToggle} isHe={isHe} />
    );
  }
  ...
  return (
    ...
    >
      ...
      <div className="flex-1 min-w-0">
        <p
          className={`text-xs leading-snug ${active ? 'font-semibold text-primary-700' : ''}`}
  ...
  return (
    <div className="flex flex-col" style={{ minHeight: 'calc(100vh - 56px)' }}>
      ...
      <div className="flex flex-1 relative">
        ...
        >
          ...
          >
            <div>
              ...
              <p className="text-[11px] mt-0.5" style={{ color: 'var(--text-muted)' }}>
                {done}/{total} {isHe ? 'הושלמו' : 'completed'} · {MODULES.length}{' '}
        ...
        {/* Main content */}
        <main className="flex-1 overflow-y-auto" style={{ maxHeight: 'calc(100vh - 98px)' }}>
          {activeSection && (
            <div className="max-w-3xl mx-auto px-4 sm:px-6 py-8">
              ...
              <div className="flex items-center gap-1.5 flex-wrap mb-3">
                ...
                <span
                  className="text-[11px] ms-auto tabular-nums"
                  dir="ltr"
                  style={{ color: 'var(--text-muted)' }}
                >
                  {activeIdx + 1} / {total}
              ...
              {/* Navigation */}
              <div
                className="flex items-center justify-between mt-10 pt-6 border-t gap-3"
                style={{ borderColor: 'var(--border)' }}
              >
                <button
                  onClick={goPrev}
                ...
                <button
                  onClick={() => {
                    if (!completed.includes(activeSection.id)) toggle(activeSection.id);
                    goNext();
                  }}
                  ...
                  style={{
                    background: '#1a3a8f',
                    color: '#fff',
                    boxShadow: '0 2px 8px rgba(26,58,143,.25)',
                  }}
                >
                  {isHe ? (
                    <>
